...
class BaseballDataScraper:
    ...
    async def check_player(self, page: Page, player_id: int) -> bool:
        ...
        try:
            name_element = await page.locator('//*[@id="cphContents_cphContents_cphContents_playerProfile_lblName"]').text_content()
            return bool(name_element.strip())
        except Exception as e:
...
async def main():
    ...
    await scraper.run(start_id=50000, end_id=80001)
